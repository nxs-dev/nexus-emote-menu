...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Animazioni',
        ['danceemotes'] = "🕺 Animazioni Danza",
        ['propemotes'] = "📦 Animazioni Oggetti",
        ['favoriteemotes'] = "🌟 Favorite",
        ['favoriteinfo'] = "Scegli un animazione qui per impostarla tra le preferite.",
        ['rfavorite'] = "Reset favorite",
        ['prop2info'] = "❓ Le animazioni con l'oggetti saranno alla fine",
        ['set'] = "Set (",
        ['setboundemote'] = ") per diventare la tua bind-emote?",
        ['newsetemote'] = "~w~ è ora una animazione bindata, premi ~g~CapsLock~w~ per usarla.",
        ['cancelemote'] = "Cancella animazione",
        ['cancelemoteinfo'] = "~r~X~w~ Ferma l'attuale animazione",
        ['walkingstyles'] = "Stile camminata",
        ['resetdef'] = "Ripristina default",
        ['normalreset'] = "Normale (Reset)",
        ['moods'] = "Stati d'animo",
        ['infoupdate'] = "Informazioni",
        ['infoupdateav'] = "Informazioni (Aggiornamenti disponibili)",
        ['infoupdateavtext'] = "Un aggiornamento è disponibile, contatta uno ~y~scripter~w~",
        ['suggestions'] = "Suggerimenti?",
        ['suggestionsinfo'] = "'Contatta il tuo scripter ✉️",
        ['notvaliddance'] = "Non è una danza valida.",
        ['notvalidemote'] = "Non è un animazione valida.",
        ['nocancel'] = "Nessuna animazione da fermare.",
        ['maleonly'] = "Questa animazione è solo per gli uomini",
        ['emotemenucmd'] = "fai /emotemenu per il menu.",
        ['shareemotes'] = "👫 Animazioni Condivise.",
        ['shareemotesinfo'] = "Invita una persona vicino per l'animazione.",
        ['sharedanceemotes'] = "🕺 Danze Condivise",
        ['notvalidsharedemote'] = "Non è una animazione condivisa valida.",
        ['sentrequestto'] = "Invio richiesta a  ~y~",
        ['nobodyclose'] = "Nessuno ~r~abbastanza~w~ vicino.",
        ['doyouwanna'] = "~y~Y~w~ per accettare, ~r~L~w~ per rifiutare (~g~",
        ['refuseemote'] = "Animazione rifiutata.",
        ['makenearby'] = "Animazione alla persona vicina",
        ['camera'] = "Premi ~y~G~w~ per usare il flash della fotocamera.",
        ['makeitrain'] = "Premi ~y~G~w~ per far piovere.",
        ['pee'] = "Tieni premuto ~y~G~w~ per fare la pipi.",
        ['spraychamp'] = "Tieni premuto ~y~G~w~ per stappare lo champagne",
        ['bound'] = "Bind ",
        ['to'] = "a",
        ['currentlyboundemotes'] = " Animazioni bindate:",
        ['notvalidkey'] = "Non è un tasto valido.",
        ['keybinds'] = "🔢 Combinazioni tasti",
        ['keybindsinfo'] = "Usa"
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
